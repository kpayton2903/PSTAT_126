...
Now we use $gamble$ as the response and the rest as predictors to fit a MLR model to the [[data:\\\\](data:\\){.uri}]([data:\\](data:\){.uri}){.uri}
...
Our fitted model is now: $$\hat{\text{gamble}}=-2.6596+5.7996*I(\text{sex=female})+6.5181*\text{income}-6.3432*\text{income}*I(\text{sex=female}).$$ And in this model, for a female, if $income$ increases by $1$ unit, then the $gamble$ will increase by $6.5181-6.3432=0.1749$.\
