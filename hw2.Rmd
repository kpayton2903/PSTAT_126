...
```{r}
plot(rating~-protein, data=Cereal, main="Rating vs Protein")
plot(rating~-fat, data=Cereal, main="Rating vs Fat")
plot(rating~-fiber, data=Cereal, main="Rating vs Fiber")
plot(rating~-carbo, data=Cereal, main="Rating vs Carbohydrates")
plot(rating~-sugars, data=Cereal, main="Rating vs Sugar")
plot(rating~-potass, data=Cereal, main="Rating vs Potassium")
plot(rating~-vitamins, data=Cereal, main="Rating vs Vitamins")
plot(rating~-cups, data=Cereal, main="Rating vs Cups")
```
